...
public class I18n {
    ...
    public static final String PASSWORD_VERIFICATION_TOKEN_CONTENT_ERROR = "error.account,verification.contentError";
    public static final String PASSWORD_VERIFICATION_TOKEN_EXPIRE_ERROR = "error.account,verification.expireError";
